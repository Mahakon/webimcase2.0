...
if (!$_GET['code']) {
     ...
     * out - $data
     */
    $token = json_decode(file_get_contents('https://oauth.vk.com/access_token?client_id=***&redirect_uri=https://lendos.me/webimcase2/myWorkPlace.php&client_secret=****&code=' . $_GET['code']), true);
...
<!-- Wellcome message for outlog users-->
    <div class="alert alert-success wellcome-message" role="alert" aria-label="You're not log in">
        <h4 class="alert-heading">Добро пожаловать, $name</h4>
    </div>
