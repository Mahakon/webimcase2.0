        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav">
                <li class="nav-item active">
                    <a class="nav-link" href="myWorkPlace.php" aria-label="Go to Home">Ваш профиль<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" aria-label="Choose log">
                        ...
                        "https://oauth.vk.com/authorize?client_id=****&display=page&redirect_uri=https://lendos.me/webimcase2/myWorkPlace.php&response_type=code"'>in
                        </button>
                    </div>
                </li>
            </ul>
...
<!-- Wellcome message for outlog users-->
    <div class="alert alert-success wellcome-message" role="alert" aria-label="You're not log in">
        <h4 class="alert-heading">Добро пожаловать в WebimCase</h4>
        <p>Извените, но Вы <b>не авторизированы</b>:(</p>
        <hr>
        <p class="mb-0">
            <input aria-label="Log in" onclick='location.href=
            "https://oauth.vk.com/authorize?client_id=****&display=page&redirect_uri=https://lendos.me/webimcase2/myWorkPlace.php&response_type=code"'
